#ifndef SL_EMLIB_GPIO_INIT_CONTROL_PIN_1_CONFIG_H
#define SL_EMLIB_GPIO_INIT_CONTROL_PIN_1_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_CONTROL_PIN_1_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_CONTROL_PIN_1_MODE        gpioModePushPull

// <o SL_EMLIB_GPIO_INIT_CONTROL_PIN_1_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_CONTROL_PIN_1_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_CONTROL_PIN_1
// $[GPIO_SL_EMLIB_GPIO_INIT_CONTROL_PIN_1]
#define SL_EMLIB_GPIO_INIT_CONTROL_PIN_1_PORT    gpioPortF
#define SL_EMLIB_GPIO_INIT_CONTROL_PIN_1_PIN     4
// [GPIO_SL_EMLIB_GPIO_INIT_CONTROL_PIN_1]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_CONTROL_PIN_1_CONFIG_H