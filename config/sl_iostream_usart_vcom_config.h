...
// USART4 TX on PI0 for pressure case
#define SL_IOSTREAM_USART_VCOM_TX_PORT           gpioPortI
#define SL_IOSTREAM_USART_VCOM_TX_PIN            0
#define SL_IOSTREAM_USART_VCOM_TX_LOC            2

// USART4 RX on PI1 for pressure case
#define SL_IOSTREAM_USART_VCOM_RX_PORT           gpioPortI
